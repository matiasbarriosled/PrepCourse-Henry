...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var objetoNuevo = objeto;
   objetoNuevo[propiedad] = null;
...
function eliminarPropiedad(objeto, propiedad) {
   ...
   // Tu código:
   var objetoRecibido = objeto;
   delete objetoRecibido[propiedad];
...
function verificarPassword(objetoUsuario, password) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   let propPass = objetoUsuario.password;
   if(password === propPass){
      return true;
   }
   else{
      return false;
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   var arreglo = objetoMuchosUsuarios;
   for (let i=0; i<arreglo.length; i++){
      arreglo[i].esPremium=true;
   }
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function(){
      let descontar = this.precio*this.porcentajeDeDescuento;
