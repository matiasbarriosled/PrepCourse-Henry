...
class Persona {
   ...
   detalle = function(){
      let objeto = {nombre : this.nombre,apellido : this.apellido,edad : this.edad,domicilio : this.domicilio,};
      return objeto;
   }
}
...
function crearInstanciaPersona(nombre, apellido, edad, domicilio) {
   ...
   // Tu código:
   var claseInstanciada = new Persona(nombre, apellido, edad, domicilio);
